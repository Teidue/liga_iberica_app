...
export class SeedService implements OnApplicationBootstrap {
  ...
  private async seed() {
    ...
    const savedMatchDays = await this.matchDaysRepo.save([
      this.matchDaysRepo.create({
        fecha: this.daysFromNow(-21),
        tournamentId: savedT2.id,
        clubId: savedClub1.id,
        cerrado: true,
      }),
      this.matchDaysRepo.create({
        fecha: this.daysFromNow(-7),
        tournamentId: savedT2.id,
        clubId: savedClub2.id,
        cerrado: true,
      }),
      this.matchDaysRepo.create({
        fecha: this.daysFromNow(7),
      ...
      this.matchDaysRepo.create({
        fecha: this.daysFromNow(35),
        tournamentId: savedT2.id,
        clubId: savedClub1.id,
        cerrado: false,
      }),
      this.matchDaysRepo.create({
        fecha: this.daysFromNow(65),
        tournamentId: savedT3.id,
        clubId: savedClub1.id,
        cerrado: false,
      }),
      this.matchDaysRepo.create({
        fecha: this.daysFromNow(80),
        tournamentId: savedT3.id,
        clubId: savedClub2.id,
        cerrado: false,
      }),
    ...
    // ── Inscripciones ────────────────────────────────────────────────────────
    const [savedIns1, savedIns2, savedIns3] =
      await this.tournamentTeamsRepo.save([
        this.tournamentTeamsRepo.create({
          tournamentId: savedT2.id,
          teamId: savedTeam1.id,
          montoInscripcion: 200,
        }), // Tigres → Apertura
        this.tournamentTeamsRepo.create({
          tournamentId: savedT2.id,
          teamId: savedTeam2.id,
          montoInscripcion: 200,
        }), // Leones → Apertura
        this.tournamentTeamsRepo.create({
          tournamentId: savedT3.id,
          teamId: savedTeam3.id,
          montoInscripcion: 250,
        }), // Halcones → Clausura
      ]);
    ...
    await this.paymentsRepo.save([
      this.paymentsRepo.create({
        tournamentTeamId: savedIns1.id,
        monto: 80,
        fecha: this.daysFromNow(-25),
      ...
      this.paymentsRepo.create({
        tournamentTeamId: savedIns1.id,
        monto: 80,
        fecha: this.daysFromNow(-18),
        metodo: PaymentMethod.BINANCE,
        referencia: 'BIN-002-2025',
        imagen: null,
        aprobado: true,
        status: PaymentStatus.APPROVED,
      }),
      this.paymentsRepo.create({
        tournamentTeamId: savedIns1.id,
        monto: 40,
        fecha: this.daysFromNow(-3),
        metodo: PaymentMethod.ZINLI,
        referencia: 'ZIN-003-2025',
        imagen: null,
        aprobado: false,
        status: PaymentStatus.PENDING,
      }),
      this.paymentsRepo.create({
        tournamentTeamId: savedIns2.id,
        monto: 70,
        fecha: this.daysFromNow(-28),
      ...
      this.paymentsRepo.create({
        tournamentTeamId: savedIns2.id,
        monto: 80,
        fecha: this.daysFromNow(-20),
        metodo: PaymentMethod.BINANCE,
        referencia: 'BIN-005-2025',
        imagen: null,
        aprobado: false,
      ...
      this.paymentsRepo.create({
        tournamentTeamId: savedIns2.id,
        monto: 50,
        fecha: this.daysFromNow(-5),
        metodo: PaymentMethod.TRANSFERENCIA,
        referencia: 'TRF-006-2025',
        imagen: null,
        aprobado: false,
        status: PaymentStatus.PENDING,
      }),
      this.paymentsRepo.create({
        tournamentTeamId: savedIns3.id,
        monto: 125,
        fecha: this.daysFromNow(-2),
    ...
    const [savedRoberto, savedFelipe, savedNicolasG, savedCarmen] =
      await this.guestsRepo.save([
        this.guestsRepo.create({
          nombre: 'Roberto Jiménez Soto',
          documento: 'V9988776',
          notas: null,
        }),
        this.guestsRepo.create({
          nombre: 'Felipe Castillo Vera',
          documento: 'V8877665',
          notas: null,
        }),
        this.guestsRepo.create({
          nombre: 'Nicolás Blanco Pinto',
          documento: 'V7766554',
          notas: null,
        }),
        this.guestsRepo.create({
